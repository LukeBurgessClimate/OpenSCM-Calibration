...
truth = {
    ...
    "y0_co":UNIT_REGISTRY.Quantity(60,"ppb"),
...
# #weight untill 1980
# spin_down = 1980-years[0]
# normalisation_series[:,spin_down:]=1e40
...
bounds_dict = {
    ...
    "hydroxyl_scale": [
     ...
     "y0_co":[
        UNIT_REGISTRY.Quantity(10,"ppb"),
        UNIT_REGISTRY.Quantity(120,"ppb")
    ],
    "y0_oh":[
