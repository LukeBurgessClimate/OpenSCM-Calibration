...
def do_experiments(k1,k2, k3
    ...
    if years.size <100:
        ...
        for year in range(n_years*2):
            temp5[:,50 + year+1] = 1.01*temp5[:,50 + year]
        for year in range(n_years*2):
            temp5[:,50 + year+1+2*n_years] = (1/1.01) * temp5[:,50 + year+2*n_years]
        ...
        temp4[2,50+n_years*3+1:]=temp4[2,50+n_years*3]
...
fig, axd = plt.subplot_mosaic(
    mosaic=[
        ...
        [cost_name,'string']+parameters_mosaic,
    ],
    figsize=(12, 6),
)
